...
# convenience calls for gain plots with additional notation
source('GainPlotExtra.R')
...
GainCurvePlotWithExtras(perfTest, "predSalary", "Salary", "Baseball Salaries", gainx, tmpfun) 
...
GainCurvePlotWithExtras(dtest, "model2", "diabetic", "Diabetes", gainx, tmpfun) 
