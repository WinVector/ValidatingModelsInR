...
sub <- function(expr,TruePositives,FalsePositives,FalseNegatives,TrueNegatives) {
...
# Show F1 and BalancedAccuracy do not always vary together
TotTrue <- 5
TotFalse <- 5
TruePositives <- 3
TrueNegatives <- 3
F1a <- sub(F1,
           TruePositives,TotFalse-TrueNegatives,TotTrue-TruePositives,TrueNegatives)
BAa <- sub(BalancedAccuracy,
           TruePositives,TotFalse-TrueNegatives,TotTrue-TruePositives,TrueNegatives)
TruePositives2 <- TruePositives-1
TrueNegatives2 <- TrueNegatives+1
F1b <- sub(F1,
           TruePositives2,TotFalse-TrueNegatives2,TotTrue-TruePositives2,TrueNegatives2)
BAb <- sub(BalancedAccuracy,
           TruePositives2,TotFalse-TrueNegatives2,TotTrue-TruePositives2,TrueNegatives2)
sign(F1b-F1a)==sign(BAb-BAa)

# F1 and Balanced accuracy are scale invarient, so this example works no matter
# how we scale it.
print(F1)
print(BalancedAccuracy)
```
